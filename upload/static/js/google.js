...
document.writeln('<option value="0"' + google_default_0 + '>ค้นหาในเว็บ</option>');
document.writeln('<option value="1"' + google_default_1 + '>ค้นหานอกเว็บ</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">ค้นหา</button>');
