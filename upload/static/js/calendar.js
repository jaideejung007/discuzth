...
function loadcalendar() {
	...
	s += '<tr align="center" id="calendar_week"><td onclick="refreshcalendar(yy, mm-1)" title="เดือนก่อน" style="cursor: pointer;"><a href="javascript:;">&laquo;</a></td><td colspan="5" style="text-align: center"><a href="javascript:;" onclick="showdiv(\'year\');doane(event)" class="dropmenu" title="คลิกเลือกปี" id="year"></a>&nbsp; - &nbsp;<a id="month" class="dropmenu" title="คลิกเลือกเดือน" href="javascript:;" onclick="showdiv(\'month\');doane(event)"></a></td><td onclick="refreshcalendar(yy, mm+1)" title="เดือนถัดไป" style="cursor: pointer;"><a href="javascript:;">&raquo;</a></td></tr>';
	...
	s += '<tr id="hourminute" class="pns"><td colspan="4" align="left"><input type="text" size="1" value="" id="hour" class="px vm" style="width: 16px;margin-right: 5px;" onKeyUp=\'this.value=this.value > 23 ? 23 : zerofill(this.value);controlid.value=controlid.value.replace(/\\d+(\:\\d+)/ig, this.value+"$1")\' title="ระบุชั่วโมง"> : ';
	s += '<span id="fullhourselector"><input type="text" size="1" value="" id="minute" class="px vm" style="width: 16px;margin: 0px 5px;" onKeyUp=\'this.value=this.value > 59 ? 59 : zerofill(this.value);controlid.value=controlid.value.replace(/(\\d+\:)\\d+/ig, "$1"+this.value)\' title="ระบุนาที"> น.</span>';
	s += '<span id="halfhourselector"><select id="minutehalfhourly" onchange=\'this.value=this.value > 59 ? 59 : zerofill(this.value);controlid.value=controlid.value.replace(/(\\d+\:)\\d+/ig, "$1"+this.value)\'><option value="00">00</option><option value="30">30</option></select> น.</span>';
	s += '</td><td align="right" colspan="3"><button class="pn" onclick="confirmcalendar();"><em>ตกลง</em></button></td></tr>';
	s += '</table></div></div>';
