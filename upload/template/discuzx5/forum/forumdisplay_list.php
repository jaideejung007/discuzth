...
<div id="threadlist" class="tl bm bmw"{if $_G['uid']} style="position: relative;"{/if}>
	...
	<div class="dz_list_top">
		<!--{if CURMODULE != 'guide'}-->
			...
			<a id="filter_kmsj" href="javascript:;" class="showmenu kmy{if $_GET['dateline']} kmon{/if}" onmouseover="showMenu(this.id)">{if !$_GET['dateline']}{lang search_any_date}{lang all}{elseif $_GET['dateline'] == '86400'}{lang last_1_days}{elseif $_GET['dateline'] == '172800'}{lang last_2_days}{elseif $_GET['dateline'] == '604800'}{lang list_one_week}{elseif $_GET['dateline'] == '2592000'}{lang list_one_month}{elseif $_GET['dateline'] == '7948800'}{lang list_three_month}{else}{lang tmp081}{/if}</a><!--discuzth-->
...
<div id="filter_special_menu" class="p_pop" style="display:none" change="location.href='forum.php?mod=forumdisplay&fid=$_G['fid']&filter='+$('filter_special').value">
	...
	<div id="filter_kmsj_menu" class="p_pop" style="display:none">
		<ul>
			<li><a href="forum.php?mod=forumdisplay&fid=$_G['fid']&orderby={$_GET['orderby']}&filter=dateline$forumdisplayadd['dateline']{if $_GET['archiveid']}&archiveid={$_GET['archiveid']}{/if}">{lang search_any_date}{lang all}</a></li><!--discuzth-->
