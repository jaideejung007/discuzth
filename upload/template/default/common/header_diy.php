...
<div id="controlpanel" class="cl hide">
	<div id="controlheader" class="cl">
		<p class="y">
			...
			<!--{if CURMODULE != 'mobilediy'}-->
				<span id="mobilediy" class="unusable"><a target="_blank" href="portal.php?mod=mobilediy&url={echo urlencode(str_replace('diy=yes', '', $_SERVER['REQUEST_URI']));}">{lang mobilediy}</a></span>
			<!--{/if}-->
