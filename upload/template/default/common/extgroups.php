...
<div style="width:140px">
	...
	<!--{if $extgroupids}-->
		<ul class="btda ptn mbn pbn extg">
			<li><a href="home.php?mod=spacecp&ac=usergroup&gid=$_G['member'][groupid]">{$_G[group][grouptitle]}{echo g_icon($_G['group']['groupid'], 1, 20);}</a></li>
			<!--{loop $extgroupids $extgid}-->
				<li><a href="home.php?mod=spacecp&ac=usergroup&gid=$extgid">{$_G[cache][usergroups][$extgid][grouptitle]}{echo g_icon($extgid, 1, 20);}</a></li>
			<!--{/loop}-->
		</ul>
	<!--{/if}-->
