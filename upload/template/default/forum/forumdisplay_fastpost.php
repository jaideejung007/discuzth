...
<div id="f_pst" class="bm">
	...
	<div class="bm_c">
		<form method="post" autocomplete="off" id="fastpostform" action="forum.php?mod=post&action=newthread&fid=$_G[fid]&topicsubmit=yes&infloat=yes&handlekey=fastnewpost" onSubmit="return fastpostvalidate(this)">
			...
			<div class="cl">
				<!--{if !empty($_G['setting']['pluginhooks']['forumdisplay_fastpost_editor_body'])}-->
					<!--{hook/forumdisplay_fastpost_editor_body}-->
				<!--{else}-->
					<!--{subtemplate forum/forumdisplay_fastpost_editor_body}-->
				<!--{/if}-->
			...
			<!--{if $allowpostattach && empty($_G['setting']['pluginhooks']['forumdisplay_fastpost_editor_body'])}-->
				<script type="text/javascript">
				var editorid = '';
