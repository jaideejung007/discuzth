	...
	<div class="c floatwrap">
		<table class="list" cellspacing="0" cellpadding="0">
			...
			<!--{loop $warnings $warning}-->
				<tr>
					<td><!--{if $_G['setting']['moduser_public']}--><a href="home.php?mod=space&uid={$warning['operatorid']}" target="_blank">$warning['operator']</a><!--{else}-->{lang thread_moderations_team}<!--{/if}--></td>
