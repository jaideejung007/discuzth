...
<div class="f_c">
	<h3 class="flb">
		<em id="return_mods">
			<!--{if $modact == 'delete'}-->{lang delete}<!--{elseif $modact == 'ignore'}-->{lang ignore}<!--{elseif $modact == 'invalidate'}-->{lang invalidate}<!--{elseif $modact == 'dismiss'}-->{lang dismiss}<!--{else}-->{lang validate}<!--{/if}-->
