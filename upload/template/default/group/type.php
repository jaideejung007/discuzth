				...
				<div class="bm">
					...
					<div class="bm_c">
						<ul id="g_guide" class="mbm">
							<li><div class="group_createico group_create01"></div><label><strong class="xi1">{lang group_create}</strong><span class="xg1">{lang create_group_message1}</span></label></li>
							<li><div class="group_createico group_create02"></div><label><strong class="xi1">{lang personality_setting}</strong><span class="xg1">{lang create_group_message2}</span></label></li>
							<li><div class="group_createico group_create03"></div><label><strong class="xi1">{lang invite_friend}</strong><span class="xg1">{lang create_group_message3}</span></label></li>
							<li><div class="group_createico group_create04"></div><label><strong class="xi1">{lang group_upgrade}</strong><span class="xg1">{lang create_group_message4}</span></label></li>
						</ul>
