				...
				<table cellpadding="0" cellspacing="0" class="tfm">
					<tr>
						...
						<td>
							...
							<!--{if !empty($space['residecountry'])&&!empty($space['resideprovince'])&&!empty($space['residecity'])}--><p>{lang comefrom} $space[residecountry] $space[resideprovince] $space[residecity]</p><!--{/if}-->
