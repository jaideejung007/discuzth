						...
						<tr>
							<th>
								<div class="avatar mbn cl">
									<a href="home.php?mod=spacecp&ac=avatar" title="{lang memcp_avatar}" id="edit_avt"><!--{if $_G['group']['allowavatarupload']}--><span id="edit_avt_tar">{lang memcp_avatar}</span><!--{/if}--><!--{avatar($_G['uid'], 'middle')}--></a>
								</div>
