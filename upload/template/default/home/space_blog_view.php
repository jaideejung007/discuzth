...
<!--{/if}-->
					...
					<div class="vw mbm">
						...
						<div class="o cl">
							...
							<!--{if helper_access::check_module('doing')}--><a href="home.php?mod=spacecp&ac=doing&type=blog&id=$blog[blogid]&handlekey=sharebloghk_{$blog[blogid]}" id="a_share" onclick="showWindow(this.id, this.href, 'get', 0);" class="oshr">{lang share}</a><!--{/if}-->
