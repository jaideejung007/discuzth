...
<div class="header cl">
	...
	<h2>{lang collection}{lang search}</h2>
	<div class="my"><a href="forum.php?mod=collection"><i class="dm-house"></i></a></div>
</div>
<form class="searchform" method="post" autocomplete="off" action="search.php?mod=collection">
