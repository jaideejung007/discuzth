...
<div class="tip">
	<form id="magicform" method="post" action="home.php?mod=magic&action=mybox&infloat=yes" onsubmit="ajaxpost('magicform', 'return_magics', 'return_magics', 'onerror');return false;">
		...
		<div class="medal_tip_box" id="hkey_magics">
		...
		<div class="tip_btn" id="hbtn_magics">
			<!--{if $operation == 'give'}-->
