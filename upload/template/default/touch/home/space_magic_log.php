...
<div class="magic_log_list">
	<div class="dhnv flex-box mt10 cl">
		<a href="home.php?mod=magic&action=log&operation=uselog" class="flex{if $_GET['operation'] == 'uselog'} mon{/if}">{lang magics_log_use}</a>
		<a href="home.php?mod=magic&action=log&operation=buylog" class="flex{if $_GET['operation'] == 'buylog'} mon{/if}">{lang magics_log_buy}</a>
		<a href="home.php?mod=magic&action=log&operation=givelog" class="flex{if $_GET['operation'] == 'givelog'} mon{/if}">{lang magics_log_present}</a>
		<a href="home.php?mod=magic&action=log&operation=receivelog" class="flex{if $_GET['operation'] == 'receivelog'} mon{/if}">{lang magics_log_receive}</a>
	</div>
	<!--{if $operation == 'uselog'}-->
		<!--{if $loglist}-->
			<table summary="{lang magics_log_use}" cellspacing="0" cellpadding="0" class="dt" style="width: 100%;">
				<tr class="alt">
	...
	<!--{elseif $operation == 'buylog'}-->
		<!--{if $loglist}-->
			<table summary="{lang magics_log_buy}" cellspacing="0" cellpadding="0" class="dt" style="width: 100%;">
				<tr class="alt">
					<th>{lang magics_name}</th>
	...
	<!--{elseif $operation == 'receivelog'}-->
		<!--{if $loglist}-->
			<table summary="{lang magics_log_receive}" cellspacing="0" cellpadding="0" class="dt" style="width: 100%;">
				<tr class="alt">
					<th>{lang magics_name}</th>
