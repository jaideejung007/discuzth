	...
	<div id="dhnavs">
		<div id="dhnavs_li">
			<ul class="swiper-wrapper">
				<li class="swiper-slide{if $_GET[view] == 'threads'} mon{/if}"><a href="misc.php?mod=ranklist&type=forum&view=threads">{lang ranklist_post}</a></li>
				<li class="swiper-slide{if $_GET[view] == 'posts'} mon{/if}"><a href="misc.php?mod=ranklist&type=forum&view=posts">{lang ranklist_reply}</a></li>
				<li class="swiper-slide{if $_GET[view] == 'today'} mon{/if}"><a href="misc.php?mod=ranklist&type=forum&view=today">{lang ranklist_post_day}</a></li>
			</ul>
		</div>
	</div>
</div>
