...
var dataLoaded = function (json, isInit) {
	...
	if (isInit) {
		...
		threadTitle = json.Variables.thread.subject ? json.Variables.thread.subject : 'ขอเชิญชวนเข้ามาชมภาพถ่ายนี้';
		threadContent = 'ฉันได้เข้าร่วมในนิทรรศการภาพถ่ายที่จัดโดย #' + SITE_INFO.siteName + '#เข้ามาชมเหมือนฉันสิ';
