...
$lang = array(
	...
	'blackls_updated' => 'อัปเดตรายชื่อที่ไม่ต้องการติดต่อ',
	...
	'db_back_dos8p3_failed' => 'The server has enabled DOS 8.3 file name support. To avoid the risk of database explosion, online database backup is not allowed.',
	...
	'admin_mobile_exists' => 'หมายเลขโทรศัพท์นี้มีอยู่แล้ว กรุณาย้อนกลับไปและลองใช้หมายเลขโทรศัพท์อื่น',
	...
	'replacemykey_succeed' => 'อัปเดตคีย์สำเร็จแล้ว กรุณาอัปเดตแคชและตรวจสอบสถานะของแต่ละแอปย่อย',
	'replacemykey_false' => 'การอัปเดตคีย์ไม่สำเร็จ กรุณาตรวจสอบว่าไฟล์สามารถเขียนได้หรือฐานข้อมูลเป็นปกติอยู่ หากจำเป็นต้องดำเนินการ กรุณากำหนดค่า UC_KEY ของแต่ละแอปพลิเคชันเพื่อให้แน่ใจว่าการทำงานยังคงปกติดี',
