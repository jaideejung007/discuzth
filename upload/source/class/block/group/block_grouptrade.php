...
class block_grouptrade extends discuz_block {
	...
	function __construct() {
		$this->setting = [
			...
			'digest' => [
				...
				'type' => 'mcheckbox',
				'value' => [
					[1, 'grouptrade_digest_1'],
					[2, 'grouptrade_digest_2'],
					[3, 'grouptrade_digest_3'],
					[0, 'grouptrade_digest_0']
				],
			],
			'stick' => [
				...
				'type' => 'mcheckbox',
				'value' => [
					[1, 'grouptrade_stick_1'],
					[2, 'grouptrade_stick_2'],
					[3, 'grouptrade_stick_3'],
					[0, 'grouptrade_stick_0']
				],
			],
			'recommend' => [
			...
			'orderby' => [
				...
				'type' => 'mradio',
				'value' => [
					['dateline', 'grouptrade_orderby_dateline'],
			...
			'gviewperm' => [
				...
				'type' => 'mradio',
				'value' => [
					['-1', 'grouptrade_gviewperm_nolimit'],
	...
	function blockclass() {
		return ['trade', lang('blockclass', 'blockclass_group_trade')];
	}

	function fields() {
		return [
			'id' => ['name' => lang('blockclass', 'blockclass_field_id'), 'formtype' => 'text', 'datatype' => 'int'],
			'url' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_url'), 'formtype' => 'text', 'datatype' => 'string'],
			'title' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_title'), 'formtype' => 'title', 'datatype' => 'title'],
			'pic' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_pic'), 'formtype' => 'pic', 'datatype' => 'pic'],
			'summary' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_summary'), 'formtype' => 'summary', 'datatype' => 'summary'],
			'totalitems' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_totalitems'), 'formtype' => 'text', 'datatype' => 'int'],
			'author' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_author'), 'formtype' => 'text', 'datatype' => 'text'],
			'authorid' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_authorid'), 'formtype' => 'text', 'datatype' => 'int'],
			'price' => ['name' => lang('blockclass', 'blockclass_grouptrade_field_price'), 'formtype' => 'text', 'datatype' => 'text'],
		];
	}
