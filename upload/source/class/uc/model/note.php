...
const UC_NOTE_REPEAT = 5;
const UC_NOTE_TIMEOUT = 15;
const UC_NOTE_GC = 10000;
...
class notemodel {
	...
	function sendone($appid, $noteid = 0, $note = '') {
		...
		if(((defined('UC_STANDALONE') && !empty(constant('UC_STANDALONE'))) || (defined('IN_DISCUZ') && in_array($note['operation'], ['deleteuser', 'renameuser', 'updatepw']))) && @include UC_ROOT.'./extend_client.php') {
