...
class table_common_member_profile extends discuz_table_archive {
	...
	public function __construct() {
		...
		$this->_fields = ['uid', 'realname', 'gender', 'birthyear', 'birthmonth', 'birthday', 'constellation',
	...
	public function fetch_all_field_value($field) {
		return in_array($field, $this->_fields, true) ? DB::fetch_all('SELECT DISTINCT(`'.$field.'`) FROM '.DB::table($this->_table), null, $field) : [];
	}
