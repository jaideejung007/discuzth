...
class optimizer_dbbackup_clean {
	...
	public function check() {
		...
		if(!$filecount) {
			$return = ['status' => 0, 'type' => 'none', 'lang' => lang('optimizer', 'optimizer_dbbackup_clean_safe')];
		} else {
			$return = ['status' => 1, 'type' => 'notice', 'lang' => lang('optimizer', 'optimizer_dbbackup_clean_delete', ['filecount' => $filecount])];
		}
		return $return;
	}
