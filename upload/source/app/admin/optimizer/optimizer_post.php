...
class optimizer_post {
	...
	public function check() {
		...
		if($count) {
			$return = ['status' => '1', 'type' => 'header', 'lang' => lang('optimizer', 'optimizer_post_need_split', ['count' => $count])];
		} else {
			$return = ['status' => '0', 'type' => 'header', 'lang' => lang('optimizer', 'optimizer_post_not_need')];
		}
		return $return;
	}
