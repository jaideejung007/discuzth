...
$payment_type_data = table_common_payment_order::t()->fetch_type_all($_G['uid']);
...
$count = table_common_payment_order::t()->count_by_search($_G['uid'], $optype, $beginunixstr, $endunixstr);
$order_list = [];
if($count) {
	foreach(table_common_payment_order::t()->fetch_all_by_search($_G['uid'], $optype, $_GET['starttime'], $_GET['endtime'], '', '', '', $start, $perpage) as $order) {
