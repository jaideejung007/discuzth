...
/*jaideejung007*/		$message = str_replace(array('[spoil]','[/spoil]'), array("<div style=\"display: inline;\"><div style=\"display: inline;\"><span onClick=\"if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') {  this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.innerHTML = '<a href=\'javascript:void(0);\' onClick=\'return false;\' style=\'text-decoration: none;cursor: pointer;border: 1px solid transparent;white-space: nowrap;border-radius: 4px;padding: 5px 10px 5px 10px;text-align: center;color: #edf6fd;background: #2577b1;border-color: #2985c6 #21699c #21699c #2985c6;line-height: 2;\'>Spoiler: คลิกเพื่อซ่อนข้อความ</a>'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerHTML = '<a href=\'javascript:void(0);\' onClick=\'return false;\' style=\'text-decoration: none;cursor: pointer;border: 1px solid transparent;white-space: nowrap;border-radius: 4px;padding: 5px 10px 5px 10px;text-align: center;color: #edf6fd;background: #2577b1;border-color: #2985c6 #21699c #21699c #2985c6;line-height: 2;\'>Spoiler: คลิกเพื่อดูข้อความที่ซ่อนไว้</a>'; }\" /><a href=\"javascript:void(0);\" onClick=\"return false;\" style=\"text-decoration: none;cursor: pointer;border: 1px solid transparent;white-space: nowrap;border-radius: 4px;padding: 5px 10px 5px 10px;text-align: center;color: #edf6fd;background: #2577b1;border-color: #2985c6 #21699c #21699c #2985c6;line-height: 2;\">Spoiler: คลิกเพื่อดูข้อความที่ซ่อนไว้</a></span></div><div style=\"display: inline;\"><div style=\"display: flow-root;margin: .5em 0;background: #f5f5f5;border: 1px solid #e7e7e7;border-left: 3px solid #f2930d;position: relative;padding: 6px 10px;display: none;\">","</div></div></div>"), $message);
/*jaideejung007*/	}
		$nest = 0;
