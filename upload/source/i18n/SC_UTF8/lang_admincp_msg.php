...
$lang = [
	...
	'cloudaddons_witframe_error' => 'WitFrame 访问失败',
	'collection_admin_updated' => '专辑管理操作成功',
	'counter_member_succeed' => '用户发帖数重建完成',
	'credits_duplicate' => '积分策略重复 ',
	'credits_duplicate_custom' => '与自定义积分策略重复 ',
	'credits_duplicate_default' => '与默认积分策略重复 ',
	...
	'forums_permformula_error' => '权限断言表达式无效',
	...
	'members_edit_fields_default_null' => '用户栏目 - 更多自定义资料 - 表单类型 - 可选值 不得为空，请先设置预设JSON数据结构。',
	'members_edit_fields_compare_error' => '填写的“更多自定义资料”内容，与预设JSON数据结构不一致。',
	...
	'plugins_edit_stylePage_first_invalid' => '第一个必须为“分组”配置项目，请调整显示顺序',
	...
	'forums_delete_subadmin_error' => '您无法删除存在帖子的版块',
	...
	'styles_edit_vars_succeed' => '模板变量配置更新成功 ',
	'stylevar_not_found' => '模板变量未找到',
	...
	'forums_threadtypes_delete_error' => '字段分类中存在字段无法删除',
	...
	'upgrade_patch_not_found' => '补丁文件不存在，无法下载',
	'upgrade_waiting' => '正在制作补丁文件，请稍候...',
	'upgrade_patch_download' => '请下载补丁文件',
	'upgrade_patch_create_failed' => '创建补丁文件失败',
	'upgrade_remote_get_failed' => '无法获取升级数据',
	'upgrade_latest' => '当前已经是最新版本，无需更新',
	'upgrade_info' => '检测到最新版本',
	'upgrade_diff_notice' => '目前版本中以下文件有修改，请更新时注意',
	...
	'usergroups_up_update_credits_duplicate' => '自定义用户组积分下限设置重复',
	...
	'usertag_delete_confirm' => '确认删除此用户的标签？',
	...
	'workwx_noDepartList' => '无法拉取部门信息，请检查参数设置',
	'workwx_multiAgentRule_error' => '应用规则格式错误',

	'dingtalk_noDepartList' => '无法拉取部门信息，请检查参数设置',

	'feishu_noDepartList' => '无法拉取部门信息，请检查参数设置',

	'cells_not_found' => '细胞模板不存在',
	'cells_require_error' => '缺少必填的细胞元素',
	'cells_format_error' => '禁止提交 Discuz! 模板语法、PHP 代码、JS 代码，请检查',
	'cells_edit_succeed' => '细胞模板已更新',
	'cells_cache_succeed' => '缓存更新完毕',

	'forumportal_nav_not_found' => '导航项目不存在',

	'credits_rule_delete_confirm' => '确定删除此周期策略？',

	'restful_need_redis' => '本功能需要启用 Redis',
	'restful_app_not_found' => '应用不存在',
	'restful_xml_error' => 'XML 格式错误：%s',
	'restful_api_not_found' => '接口不存在',
	'restful_api_exists' => '接口已经存在：%s',

	'tplfile_tpl_not_found' => '模板不存在',
	'tplfile_no_edit' => '此模板不允许编辑',
	'tplfile_dir_not_found' => '模板目录不存在',
	'tplfile_file_not_found' => '模板文件不存在',
	'tplfile_file_no_edit' => '模板文件不允许编辑',
	'tplfile_safe_notice' => '不允许编辑文件中的 eval、javascript 等禁止修改的部分',
	'tplfile_edit_succeed' => '模板文件已更新',

	'frame_cpmsg_title' => '提示信息',

	'founder_platform_update_succeed' => '平台配置更新成功',

	'platform_id_error' => '平台标识错误，请重新填写',
	'platform_id_exists' => '平台标识已存在，请重新填写',

	'lang_edit_error' => '请不要增减原有的语言项',
	'lang_delete_confirm' => '确认删除此语言包 Key？',
	'lang_key_exists' => 'Key 已经存在，请更换',

	'widget_update_succeed' => '组件设置更新成功',
	'widget_reset_succeed' => '组件设置已重置',

	'setting_avatar_upload_fail' => '上传失败，请重新上传',
	'setting_avatar_upload_must_img' => '上传失败，请上传图片文件',
	'setting_avatar_upload_must_square' => '上传失败，请上传方形的图片文件',

	'secqaa_click_identifier_error' => '请输入正确的标识',
	'secqaa_click_upload_error' => '压缩包上传错误',
