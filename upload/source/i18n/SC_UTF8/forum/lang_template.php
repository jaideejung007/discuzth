...
$lang = [
	...
	'activity_join_group' => '点此处马上加入 圈子',
	'activity_need_credit' => '注意：参加此活动将扣除您',
	'activity_new_signup' => '暂未通过',
	'activity_no_member' => '您还不是本 圈子 的成员不能参与此活动',
	...
	'mod_forum_member_closed' => '当前版块未开启用户需申请加入才能浏览的功能',
	'mod_forum_member_join' => '申请审核',
	'mod_forum_member_list' => '用户列表',
	'mod_forum_member_join_empty' => '目前没有申请的用户',
	'mod_forum_member_list_empty' => '目前没有用户',
	'postdelete' => '删除指定帖子',
	'postdelete_tip' => '确定删除该帖子吗？',
	'json_editor_title_placeholder' => '请输入标题（最多 60 个字）',
	'json_editor_title_publish' => '发布设置',
	'json_editor_title_cover' => '添加封面',
	'json_editor_upload_tip' => '点击上传，或将文件拖拽到此处',
	'json_editor_upload_mobile_tip' => '点击上传',
	'json_editor_upload_desc' => '图片上传格式支持 JPEG、JPG、PNG',
	'json_editor_title_types' => '主题分类',
	'json_editor_title_original' => '原创声明',
	'json_editor_title_original_0' => '无声明',
	'json_editor_title_original_1' => '声明原创',
	'json_editor_title_original_f1' => '非声明',
	'json_editor_title_tags' => '添加标签',
	'json_editor_tags_enter' => '回车生成标签',
	'json_editor_title_source' => '文章来源',
	'json_editor_source_title' => '转载平台名称',
	'json_editor_source_url' => '转载平台网站URL',
	'json_editor_top' => '回到顶部',
	'json_editor_save' => '保存',
