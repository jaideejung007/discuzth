...
<p class="mbn"><a href="home.php?mod=magic" target="_blank">回赠道具</a><span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">查看我的道具箱</a></p>',
	...
	'forum_member_new' => '{actor} 申请加入 <a href="forum.php?mod=forumdisplay&fid={fid}" target="_blank">{forumname}</a> 需要审核，请到<a href="{url}" target="_blank">管理面板</a> 进行审核',
	'forum_member_check' => '您已通过了 <a href="{url}" target="_blank">{forumname}</a> 的审核，请 <a href="{url}" target="_blank">点击这里访问</a>',
	'forum_member_check_failed' => '您没有通过 <a href="{url}" target="_blank">{forumname}</a> 的审核。',
