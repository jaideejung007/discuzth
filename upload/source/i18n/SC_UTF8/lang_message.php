...
$lang = [
	...
	'follower_status_off' => '抱歉，关注功能尚未开启',
	...
	'pm_status_off' => '抱歉，私信功能尚未开启',
	'forum_not_group' => '该版块不是圈子',
	'forum_group_status_off' => '该圈子已关闭',
	'forum_group_noallowed' => '抱歉，您没有权限访问该圈子',
	'forum_group_moderated' => '请等待圈主审核',
	'group_name_empty' => '请填写圈子名称',
	'group_name_exist' => '圈子名称已存在',
	'group_admin_noallowed' => '抱歉，您没有权限限管理此圈子',
	'group_name_failed' => '圈子名称含有敏感词',
	'group_category_empty' => '请选择圈子分类',
	'group_description_failed' => '圈子简介含有敏感词',
	'group_setup_succeed' => '圈子设置成功 ',
	...
	'account_getuserinfo_error' => '用户信息获取失败，请重试！',
	...
	'do_success' => '操作成功 ',
	'group_member_maximum' => '抱歉，该圈子等级最多可拥有{membermaximum}名成员，已达到上限',
	...
	'profile_repasswd_illegal' => '抱歉，请检查两次密码输入是否一致',
	...
	'profile_secmobile_blacklist' => '该安全手机号不在支持的范围内',
	'profile_secmobicc_null' => '请选择区号',
	...
	'group_name_oversize' => '抱歉，圈子名称超过20个字节将被截断',
	...
	'group_rediret_now' => '现在转入圈子首页',
	'group_verify' => '圈子正在审核中',
	'group_has_joined' => '您已加入该圈子',
	'group_join_need_invite' => '该圈子需要邀请才能加入',
	'group_join_succeed' => '成功加入该圈子',
	'group_join_apply_succeed' => '成功申请加入该圈子',
	'group_exit_founder' => '抱歉，圈子创始人不能退出圈子',
	'group_exit_succeed' => '已经成功退出圈子',
	'group_create_usergroup_failed' => '抱歉，您所在的用户组不能建立圈子',
	'group_create_usergroup_credits_failed' => '抱歉，您的积分不足，创建圈子需要消耗 {buildgroupcredits}',
	'group_create_max_failed' => '抱歉，您的建立圈子数量已到达设置上限，不能建立新的圈子',
	'group_category_error' => '抱歉，选择圈子分类错误',
	'group_create_mod_succeed' => '创建圈子的申请已经提交，我们会尽快进行审核',
	'group_create_succeed' => '圈子建立成功 ',
	'group_edit_only_founder' => '抱歉，只有圈子创始人可以修改圈子名称或圈子分类',
	'group_close_only_founder' => '抱歉，只有圈子创始人可以关闭圈子',
	'group_moderate_succeed' => '指定成员已审核通过',
	'group_moderate_failed' => '指定成员已被忽略',
	'group_only_one_moderator' => '抱歉，只剩最后一个圈主，必须由管理员在后台删除圈子',
	'group_choose_member' => '请选择成员',
	'group_level_cannot_do' => '抱歉，目前您的圈子等级没有此功能',
	'group_threadtype_only_founder' => '抱歉，只有圈子创始人可以管理主题分类',
	'group_threadtype_edit_succeed' => '修改主题分类成功 ',
	'group_cannot_demise' => '抱歉，本圈子暂无其他管理成员，不能进行转让',
	'group_demise_choose_receiver' => '抱歉，您尚未选择接收者',
	'group_demise_password' => '为安全起见，请输入您的登录密码',
	'group_demise_password_error' => '抱歉，密码错误',
	'group_demise_receiver_cannot_do' => '抱歉，接收者不能再拥有新的圈子',
	'group_demise_succeed' => '圈子转让成功 ',
	'group_demise_founder_only' => '抱歉，只有圈子创始人才能转让圈子',
	...
	'postdelete_only_yourself' => '只能删除自己的帖子',
	...
	'forum_group_not_groupmember' => '抱歉，您还不是本圈子成员不能发帖<br /><a href="forum.php?mod=group&action=join&fid={fid}" target="_blank">马上加入该圈子</a>',
	'forum_group_not_groupmember_guest' => '抱歉，您还不是本圈子成员不能发帖',
	...
	'getpasswd_mobile_verify_succeed' => '安全手机号验证通过，请修改您的密码',
	...
	'group_invite_failed' => '抱歉，您不是本圈子成员，不能邀请',
	...
	'search_group_closed' => '抱歉，圈子搜索已关闭',
	...
	'article_content_toolong' => '抱歉，您的文章超过 {maxportalsize} 个字符的限制',
	...
	'poll_imgoptions_invalid' => '抱歉，您上传图片的数量与投票选项的数量不一致',
	...
	'follow_do_success' => '关注成功 ',
	'unfollow_do_success' => '取消关注成功 ',
	'follow_cannot_follow' => '抱歉，您指定的信息无法关注',
	'follow_repeat' => '抱歉，您已关注，请勿重复关注',
	'follow_does_not_exist' => '抱歉，您指定的关注不存在',

	'feed_no_found' => '抱歉，您指定要查看的动态不存在',
	'no_privilege_feed_del' => '抱歉，您没有权限删除此动态',

	'follow_not_follow_self' => '不能关注自己',
	'follow_not_follow_others' => '您当前用户组不允许关注他人',
	...
	'location_login_freeze_logoff' => '登录失败，此账号已注销，请更换账号重新登录',
	...
	'secemailseccode_send_success' => '验证码发送成功，请在页面上输入邮件验证码。',
	'secemailseccode_send_failure' => '未知异常，请稍候再试。',
	'secemailseccode_send_err_1' => '发送验证码间隔过短，请稍候再试。',
	'secemailseccode_send_err_2' => '您一段时间内发送的验证码过多，请稍候再试。',
	'secemailseccode_send_err_4' => '本站点一段时间内发送的验证码过多，请稍候再试。',
	'secemailseccode_send_err_8' => '邮件验证码功能已被关闭，请稍候再试。',
	'secemailseccode_send_err_9' => '邮件服务异常，请稍候再试。',


	'profile_secmobile_null' => '请填写手机号',
	'profile_mobile_duplicate' => '该手机号已被注册，请更换手机号',
	'message_secmobile_null_err' => '请填写手机号',
	'message_secmobseccode_null_err' => '请填写短信验证码',
	'message_secmobseccode_verify_err' => '短信验证码验证失败，请重试',
	'message_secmobseccode_invalid_err' => '短信验证码已失效，请重新获取短信验证码',
	'message_verify_err' => '验证失败，请重试',
	'message_secmobile_unbind_err' => '请先绑定安全手机',
	'message_email_unbind_err' => '请先绑定安全邮箱',
	'message_seccode_null_err' => '请填写验证码',
	'message_seccode_verify_err' => '验证码验证失败，请重试',
	'message_seccode_invalid_err' => '验证码已失效，请重新获取验证码',
	'message_password_null_err' => '请填写账号密码',
	'message_password_err' => '账号密码错误',

	'account_sign_error' => '签名验证错误，请重试',
	'account_verify_success' => '验证通过',
	'account_bind_exists' => '当前用户已绑定，无法再次绑定',
	'account_bind_other_exists' => '该账号已被其他用户绑定，无法再次绑定',
	'account_bind_success' => '绑定成功',
	'account_bind_fail' => '绑定失败',
	'account_unbind_success' => '解绑成功',
	'account_unbind_fail' => '解绑失败',
	'account_change_success' => '修改成功',
	'account_change_fail' => '修改失败',
	'account_change_username_success' => '您的用户名已经修改成功',
	'account_operate_success' => '操作成功',
	'account_operate_fail' => '操作失败',
	'account_change_username_closed' => '此功能未开启',
	'account_change_username_max_times' => '您的修改次数已达上限，无法再修改',
	'account_change_credits_low' => '您的积分不满足修改用户名的条件，无法修改',
	'account_change_credits_pay_low' => '您的%s不足，无法修改',
	'account_freeze_reason_success' => '申诉已提交成功',
	'account_verify_type_error' => '安全验证类型选择出现异常，请刷新页面后重试',
	'account_authcode_error' => '授权码状态异常，请刷新页面重试！',
	'account_api_error' => '接口错误，请检查{message}',

	'password_null_error' => '执行该操作前，请先设置密码',
	'login_mobile_duplicate_error' => '系统异常，存在多个用户绑定该手机号的情况，请使用其他方式登录',
	'login_mobile_nouser_error' => '系统异常，获取用户信息出错，请使用其他方式登录',
	'login_mobile_other_error' => '系统异常，请使用其他方式登录',
	'login_mobile_reg_username_duplicate_error' => '用户账号创建失败，请重试',
	'login_mobile_reg_username_null_error' => '首次注册请先设置您的用户名',

	'account_email_notexists' => '请先绑定邮箱',
	'account_security_mobile_duplicate_error' => '该手机号已被其他账号绑定，请更换手机号',
	'account_security_logoff_confirm_null' => '请正确输入确认信息',
	'account_security_logoff_success' => '注销成功',

	'postdelete_succeed' => '删除成功 ',

	'forumportal_no_setting' => '聚合首页未设置',
	'forumportal_page_not_found' => '页面不存在',

	'forum_member_moderate_succeed' => '用户加入申请已审核通过',
	'forum_member_moderate_failed' => '用户加入申请已被忽略',
	'forum_member_error' => '抱歉，本版块只有特定用户组的用户提交申请加入才可以访问：<br />{groups}',
	'forum_member_apply' => '本版块需要提交申请才可以访问<br /><br /><a href="{url}">[ 申请加入 ]</a>',
	'forum_member_applied' => '您已提交了本版块的访问申请，请等待审核',
