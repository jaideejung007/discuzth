...
$lang = [
	...
	'agreement_yes' => '同意',
	'agreement_no' => '取消',
	'agreement_notice' => '为确保顺利进行安装操作，请您仔细阅读并充分理解授权协议的内容',
	'notset' => '不限制',
	'enable' => '开启',
	'disable' => '关闭',
	...
	'step_upgrade_title' => '开始升级',
	'step_upgrade_desc' => '正在执行数据库升级',
	'step_upgrade_confirm_title' => '注意事项',
	'step_upgrade_confirm_desc' => '开始升级前请仔细阅读下面的注意事项',
...
<p>感谢您选择 Discuz! 产品。希望我们的努力能为您提供一个高效快速、强大的站点解决方案，和强大的社区论坛解决方案。</p>

<p>产品官方网站网址：https://www.discuz.vip/。</p>
<p>产品官方讨论社区网址：https://www.dismall.com/。</p>
<p>产品官方应用中心网址：https://addon.dismall.com/。</p>
<p>产品开源代码网址为：https://code.dismall.com/。</p>

<p>合肥贰道网络科技有限公司下文中将简称“贰道网络公司”，腾讯科技（北京）有限公司将简称“腾讯公司”，Discuz! 产品将简称“本产品”。</p>

<p>Discuz! X 项目内所包含的官方应用中心由贰道网络公司承接运营，Discuz! X 开源项目由贰道网络公司承接维护，Discuz! X 及其衍生产品由贰道网络公司负责研发。Discuz! X 开源版代码由项目开源管理委员会及社区开发者共同维护。</p>

<p>用户须知：本协议是您与贰道网络公司及腾讯公司之间关于您使用此软件产品及服务的法律协议。无论您是个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，包括免除或者限制贰道网络公司责任的免责条款及对您的权利限制。请您审阅并接受或不接受本服务条款。如您不同意本服务条款及/或贰道网络公司随时对其的修改，您应不使用或主动取消贰道网络公司提供的产品。否则，您的任何对本产品中的相关服务的注册、登录、下载、查看等使用行为将被视为您对本服务条款全部的完全接受，包括接受贰道网络公司对服务条款随时所做的任何修改。</p>
<p>本服务条款一旦发生变更，贰道网络公司将在网页上公布修改内容。修改后的服务条款一旦在网站管理后台上公布即有效代替原来的服务条款。您可随时登录开源代码网址查阅最新版服务条款。如果您选择接受本条款，即表示您同意接受协议各项条件的约束。如果您不同意本服务条款，则不能获得使用本服务的权利。您若有违反本条款规定，贰道网络公司有权随时中止或终止您对贰道网络公司产品的使用资格并保留追究相关法律责任的权利。</p>
<p>在理解、同意、并遵守本协议的全部条款后，方可开始使用本产品。您可能与贰道网络公司直接签订另一书面协议，以补充或者取代本协议的全部或者任何部分。</p>

<p>贰道网络公司及腾讯公司拥有本产品的全部知识产权。本产品只供许可协议，并非出售。贰道网络公司只允许您在遵守本协议各项条款的情况下复制、下载、安装、使用或者以其他方式受益于本产品的功能或者知识产权。</p>

<h3>I. 协议许可的权利</h3>
<ol>
   <li>您可以在完全遵守本许可协议的基础上，将本产品应用于非商业用途或商业用途使用（局限于本协议所适配许可的情况下），而不必支付软件版权许可费用。</li>
   <li>您可以在协议规定的约束和限制范围内修改本产品源代码（如果被提供的话）或界面风格以适应您的网站要求。</li>
   <li>您拥有使用本产品构建的网站中全部会员资料、文章及相关信息的所有权，并独立承担与使用本产品构建的网站内容的审核、注意义务，确保其不侵犯任何人的合法权益，独立承担因使用本产品和服务带来的全部责任，若造成贰道网络公司、腾讯公司及用户损失的，您应予以全部赔偿。</li>
   <li>若您需将本产品或服务用于商业用途，必须遵守中国人民共和国相关法律。若需提供技术支持方式或技术支持内容，请向官方网站获取技术支持服务。</li>
   <li>您可以从贰道网络公司提供的应用中心服务中下载适合您网站的应用程序，但应向应用程序开发者（所有者）支付相应的费用。贰道网络公司只有在经过应用程序开发者（所有者）授权后，才将应用程序下载到您的服务器上。未经许可的应用程序，您必须立刻删除，贰道网络公司、腾讯公司不承担任何责任。</li>
</ol>
...
<ol>
   ...
   <li>您从官方应用中心下载的应用程序，未经应用程序开发者（所有者）的书面许可，不得对其进行反向工程、反向汇编、反向编译等，不得擅自复制、修改、链接、转载、汇编、发表、出版、发展与之有关的衍生产品、作品等。</li>
   <li>如果您未能遵守本协议的条款，您的授权将被终止，所许可的权利将被收回，同时您应承担相应法律责任。</li>
</ol>

<h3>III. 有限担保和免责声明</h3>
<ol>
   <li>本产品及所附带的文件是作为不提供任何明确的或隐含的赔偿或担保的形式提供的。</li>
   <li>用户出于自愿而使用本产品，您必须了解使用本产品的风险，我们不承诺提供任何形式的技术支持、使用担保，也不承担任何因使用本产品而产生问题的相关责任。</li>
   <li>贰道网络公司不对使用本产品构建的网站中或者论坛中的文章或信息承担责任，全部责任由您自行承担。</li>
   <li>官方应用中心无法全面监控由第三方上传至应用中心的应用程序，因此不保证应用程序的合法性、安全性、完整性、真实性或品质等；您从官方应用中心下载应用程序时，同意自行判断并承担所有风险，而不依赖于贰道网络公司及官方应用中心。但在任何情况下，官方应用中心有权依法停止应用中心服务并采取相应行动，包括但不限于对于相关应用程序进行卸载，暂停服务的全部或部分，保存有关记录，并向有关机关报告。由此对您及第三人可能造成的损失，贰道网络公司、腾讯公司及官方应用中心不承担任何直接、间接或者连带的责任。</li>
   <li>贰道网络公司对本产品和服务之及时性、安全性、准确性不作担保，由于不可抗力因素、贰道网络公司无法控制的因素（包括黑客攻击、停断电等）等造成软件使用和服务中止或终止，而给您造成损失的，您同意放弃追究贰道网络公司、腾讯公司责任的全部权利。</li>
   <li>贰道网络公司特别提请您注意，贰道网络公司为了保障公司业务发展和调整的自主权，贰道网络公司拥有随时经或未经事先通知而修改服务内容、中止或终止部分或全部软件使用和服务的权利，修改会公布于贰道网络公司网站相关页面上，一经公布视为通知。贰道网络公司行使修改或中止、终止部分或全部软件使用和服务的权利而造成损失的，贰道网络公司、腾讯公司不需对您或任何第三方负责。</li>
</ol>

<p>有关本产品最终用户授权协议、商业授权与技术服务的详细内容，均由贰道网络公司提供。贰道网络公司拥有在不事先通知的情况下，修改授权协议和服务价目表的权利，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

<p>一旦您开始安装本产品，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权利的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
...
<p>（正文完）</p>
	...
	'version_title' => '产品说明',
	'version_notice' => '
<p>- 基于 MitFrame<sup>&reg;</sup> 内核的全新框架体系重构，既是社区又是框架，全面开拓更广泛的开放视角</p>
<p>- 从前台到后台，开放更加彻底</p>
<p>- 轻重兼顾的多功能一体化社区</p>
<p>- 全新 JSON 编辑器</p>
<p>- 版块、用户组、积分全面加强</p>
<p>- 全面拥抱 OAuth2.0 的 RESTful API 接口，开发者可随意自定义自己的接口</p>
<p><a href="https://www.dismall.com/thread-27135-1-1.html" target="_blank">点击了解更多...</a></p>
',

	'php_version_too_low' => 'PHP 版本不符合 Discuz! 的安装要求，必须满足 PHP %s',
	'php8_tips' => '您好，当前产品暂不支持 PHP 9.0 安装，请降级到至少 PHP 8.0 后再试！',
