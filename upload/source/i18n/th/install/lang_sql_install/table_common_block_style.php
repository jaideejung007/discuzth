...
$data = [[
    ...
    'name' => '[ค่าเริ่มต้น] รายชื่อชื่อบอร์ด',
    'template' =>
    [
...
[/loop]
    ...
    'styleid' => '3',
    'blockclass' => 'forum_forum',
    'name' => '[ค่าเริ่มต้น] ชื่อบอร์ด + จำนวนโพสต์ทั้งหมด',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '4',
    'blockclass' => 'forum_forum',
    'name' => '[ค่าเริ่มต้น] ชื่อบอร์ด + จำนวนโพสต์ทั้งหมด (ตามลำดับ)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ol>
...
[/loop]
    ...
    'styleid' => '5',
    'blockclass' => 'forum_forum',
    'name' => '[ค่าเริ่มต้น] ชื่อบอร์ด + จำนวนโพสต์วันนี้',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '6',
    'blockclass' => 'forum_forum',
    'name' => '[ค่าเริ่มต้น] ชื่อบอร์ด + จำนวนโพสต์วันนี้ (ตามลำดับ)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ol>
...
[/loop]
    ...
    'styleid' => '7',
    'blockclass' => 'forum_forum',
    'name' => '[ค่าเริ่มต้น] ชื่อบอร์ด (สองคอลัมน์)',
    'template' =>
    [
...
[/loop]
    ...
    'styleid' => '8',
    'blockclass' => 'forum_forum',
    'name' => '[ค่าเริ่มต้น] ชื่อบอร์ด + รายละเอียด',
    'template' =>
    [
...
[/loop]
    ...
    'styleid' => '10',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + จำนวนการตอบกลับ',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '11',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + จำนวนการเข้าชม',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '12',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + ความนิยม',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '13',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + เวลาที่โพสต์',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '14',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + เวลาที่ตอบกลับล่าสุด',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '15',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + ผู้เขียน',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '16',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + ผู้เขียน + เนื้อหาโดยย่อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '17',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ + เนื้อหาโดยย่อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '19',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อโพสต์ (รายการแรกแสดงเนื้อหาโดยย่อ)',
    'template' =>
    [
...
[/loop]
    ...
    'styleid' => '40',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] ชื่อวงใน + จำนวนสมาชิก',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '41',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] ชื่อวงใน + จำนวนสมาชิก (ตามลำดับ)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ol>
...
[/loop]
    ...
    'styleid' => '42',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] ชื่อวงใน + จำนวนโพสต์ทั้งหมด',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '43',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] ชื่อวงใน + จำนวนโพสต์วันนี้',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '44',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] ไอคอนวงใน + ชื่อ + รายละเอียด',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '45',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] รายการไอคอนวงใน',
    'template' =>
    [
...
[/loop]
    ...
    'styleid' => '46',
    'blockclass' => 'group_group',
    'name' => '[ค่าเริ่มต้น] ชื่อวงใน (สองคอลัมน์)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl2">
<ul>
...
[/loop]
    ...
    'styleid' => '48',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] หัวข้อบทความ + เวลา',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '49',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] หัวข้อบทความ + เวลา (ระบุหมวดหมู่บทความ)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '50',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] หัวข้อบทความ + เนื้อหาโดยย่อ + รูปตัวอย่าง',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '51',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] หัวข้อบทความ + เนื้อหาโดยย่อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '53',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] สไลด์รูปภาพบทความ',
    'template' =>
    [
...
runslideshow();
    ...
    'styleid' => '54',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] สไลด์รูปภาพและข้อความบทความ',
    'template' =>
    [
...
runslideshow();
    ...
    'name' => '[ค่าเริ่มต้น] ชื่อหมวดหมู่บทความ',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '56',
    'blockclass' => 'portal_category',
    'name' => '[ค่าเริ่มต้น] ชื่อหมวดหมู่บทความ (สองคอลัมน์)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl2">
<ul>
...
[/loop]
    ...
    'name' => '[ค่าเริ่มต้น] ชื่อหัวข้อพิเศษ',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '58',
    'blockclass' => 'portal_topic',
    'name' => '[ค่าเริ่มต้น] ชื่อหัวข้อพิเศษ (สองคอลัมน์)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl2">
<ul>
...
[/loop]
    ...
    'styleid' => '59',
    'blockclass' => 'portal_topic',
    'name' => '[ค่าเริ่มต้น] ชื่อหัวข้อพิเศษ + รายละเอียด + รูปตัวอย่าง',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '60',
    'blockclass' => 'portal_topic',
    'name' => '[ค่าเริ่มต้น] ชื่อหัวข้อพิเศษ + รายละเอียด',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'name' => '[ค่าเริ่มต้น] ผู้เขียน + เนื้อหา',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '63',
    'blockclass' => 'space_doing',
    'name' => '[ค่าเริ่มต้น] รูปโปรไฟล์ + ผู้เขียน + เนื้อหา',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '64',
    'blockclass' => 'space_doing',
    'name' => '[ค่าเริ่มต้น] ผู้เขียน + เนื้อหา (หลายบรรทัด) + เวลา',
    'template' =>
    [
      'raw' => '<div class="module cl xl">
<ul>
...
[/loop]
    ...
    'styleid' => '66',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] หัวข้อบล็อก + ผู้เขียน',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '67',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] หัวข้อบล็อก + เวลาที่เผยแพร่',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '68',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] หัวข้อบล็อก + จำนวนความคิดเห็น',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '69',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] หัวข้อบล็อก + ผู้เขียน + แนะนำโดยย่อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '70',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] รูปตัวอย่างบล็อก + หัวข้อ + แนะนำโดยย่อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '71',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] สไลด์รูปภาพบล็อก',
    'template' =>
    [
      'raw' => '<div class="module cl slidebox">
<ul class="slideshow">
...
[/loop]
    ...
    'name' => '[ค่าเริ่มต้น] รายการอัลบั้ม',
    'template' =>
    [
...
[/loop]
    ...
    'styleid' => '74',
    'blockclass' => 'space_album',
    'name' => '[ค่าเริ่มต้น] รายการอัลบั้ม + ชื่อ + ผู้ใช้',
    'template' =>
    [
      'raw' => '<div class="module cl ml">
<ul>
...
runslideshow();
    ...
    'name' => '[ค่าเริ่มต้น] รายการรูปโปรไฟล์สมาชิก',
    'template' =>
    [
      'raw' => '<div class="module cl ml mls">
<ul>
...
[/loop]
    ...
    'styleid' => '78',
    'blockclass' => 'member_member',
    'name' => '[ค่าเริ่มต้น] รายชื่อชื่อผู้ใช้',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '79',
    'blockclass' => 'member_member',
    'name' => '[ค่าเริ่มต้น] รูปโปรไฟล์ + ชื่อผู้ใช้ + จำนวนโพสต์ (ตามลำดับ)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ol>
...
[/loop]
    ...
    'styleid' => '80',
    'blockclass' => 'member_member',
    'name' => '[ค่าเริ่มต้น] รูปโปรไฟล์ + ชื่อผู้ใช้ + จำนวนเครดิต (ตามลำดับ)',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ol>
...
<p><a href="{url}" title="{title}"{target}>{title}</a></p>
    ...
    'name' => '[ค่าเริ่มต้น] รายการกิจกรรม',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
<dl class="cl">
	...
	<dt><a href="{url}" title="{title}"{target}>{title}</a></dt>
	<dd>{time} {place}</dd>
	<dd> มีผู้ลงทะเบียนแล้ว {applynumber} คน</dd>
</dl>
[/loop]
</div>',
      'footer' => '',
...
[/loop]
    ...
    'styleid' => '85',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] ผู้เขียนโพสต์ + หัวข้อ + เนื้อหาโดยย่อ (แสดงรูปโปรไฟล์)',
    'template' =>
    [
...
<dd style="margin-bottom: 0;">ผู้เขียน: <a href="home.php?mod=space&uid={authorid}"{target}>{author}</a></dd>
</dl>
[/loop]
</div>',
      'footer' => '',
...
<dd style="margin-bottom: 0;">ผู้เขียน: <a href="home.php?mod=space&uid={authorid}"{target}>{author}</a></dd>
    ...
    'styleid' => '86',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] หมวดหมู่บทความ + หัวข้อ',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '87',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] สไตล์เฉพาะสำหรับกระทู้รางวัล',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'styleid' => '88',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อร้อนแรงหน้าแรก - โพสต์',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '89',
    'blockclass' => 'group_thread',
    'name' => '[ค่าเริ่มต้น] หัวข้อร้อนแรงหน้าแรก - โพสต์จากวงใน',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '90',
    'blockclass' => 'space_blog',
    'name' => '[ค่าเริ่มต้น] หัวข้อร้อนแรงหน้าแรก - บล็อก',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '91',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] สไตล์เฉพาะสำหรับกระทู้แบบสำรวจ',
    'template' =>
    [
...
<dd>{summary}</dd>
    ...
    'styleid' => '92',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] สไตล์เฉพาะสำหรับกระทู้โต้วาที',
    'template' =>
    [
...
<dd>{summary}</dd>
    ...
    'styleid' => '93',
    'blockclass' => 'group_activity',
    'name' => '[ค่าเริ่มต้น] กิจกรรมวงใน: รูปขนาดใหญ่ + เนื้อหาโดยย่อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
<p>{applynumber} คนกำลังติดตาม</p>
    ...
    'styleid' => '94',
    'blockclass' => 'group_activity',
    'name' => '[ค่าเริ่มต้น] กิจกรรมวงใน: รูปขนาดเล็ก + หัวข้อ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
<dd class="xg1" style="margin: 0;">{applynumber} คนกำลังติดตาม</dd>
</dl>
[/loop]
</div>',
      'footer' => '',
...
<dd class="xg1" style="margin: 0;">{applynumber} คนกำลังติดตาม</dd>
    ...
    'styleid' => '95',
    'blockclass' => 'space_album',
    'name' => '[ค่าเริ่มต้น] รายการอัลบั้ม (คั่นด้วยเส้นแนวตั้ง)',
    'template' =>
    [
      'raw' => '<div class="module cl ml">
<ul>
...
[/order]
    ...
    'styleid' => '96',
    'blockclass' => 'space_pic',
    'name' => '[ค่าเริ่มต้น] รายการรูปภาพ (คั่นด้วยเส้นแนวตั้ง)',
    'template' =>
    [
      'raw' => '<div class="module cl ml">
<ul>
...
[/order]
    ...
    'styleid' => '97',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] รายการหัวข้อบทความแบบเศษชิ้นส่วน',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/order]
    ...
    'styleid' => '98',
    'blockclass' => 'portal_article',
    'name' => '[ค่าเริ่มต้น] รายการหน้าปกบทความ (คั่นด้วยเส้นแนวตั้ง)',
    'template' =>
    [
      'raw' => '<div class="module cl ml">
<ul>
...
[/order]
    ...
    'name' => '[ค่าเริ่มต้น] ประกาศจากเว็บไซต์',
    'template' =>
    [
      'raw' => '<div class="module cl">
<ul>
[loop]
<li><img alt="ประกาศ" src="static/image/common/ann_icon.gif"><a href="{url}" title="{title}"{target}>{title} ({starttime})</a></li>
[/loop]
</ul>
</div>',
      'footer' => '',
      ...
      'loop' => '<li><img alt="ประกาศ" src="static/image/common/ann_icon.gif"><a href="{url}" title="{title}"{target}>{title} ({starttime})</a></li>',
    ],
    'hash' => '1f88cc82',
    'getpic' => '0',
    'getsummary' => '0',
    ...
    'styleid' => '100',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] แสดงกระทู้แบบรูปภาพและข้อความ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '101',
    'blockclass' => 'group_thread',
    'name' => '[ค่าเริ่มต้น] รายการกระทู้แบบรูปภาพและข้อความ',
    'template' =>
    [
      'raw' => '<div class="module cl xld">
[loop]
...
[/loop]
    ...
    'styleid' => '102',
    'blockclass' => 'group_thread',
    'name' => '[ค่าเริ่มต้น] [ชื่อวงใน] + หัวข้อกระทู้วงใน',
    'template' =>
    [
      'raw' => '<div class="module cl xl xl1">
<ul>
...
[/loop]
    ...
    'name' => '[ค่าเริ่มต้น] ลิงก์เพื่อนบ้านแบบรูปภาพและข้อความ',
    'template' =>
    [
      'raw' => '<div class="bn lk">
<ul class="m cl">
...
<div class="forumcontent"><h5><a target="_blank" href="{url}">{title}</a></h5><p>{summary}</p></div>
    ...
    'styleid' => '104',
    'blockclass' => 'other_otherfriendlink',
    'name' => '[ค่าเริ่มต้น] ลิงก์เพื่อนบ้านแบบรูปภาพเท่านั้น',
    'template' =>
    [
      'raw' => '<div class="bn lk">
<div class="cl mbm">
...
[/loop]
    ...
    'styleid' => '105',
    'blockclass' => 'other_otherfriendlink',
    'name' => '[ค่าเริ่มต้น] ลิงก์เพื่อนบ้านแบบข้อความเท่านั้น',
    'template' =>
    [
      'raw' => '<div class="x cl">
<ul class="cl mbm">
...
[/loop]
    ...
    'name' => '[ค่าเริ่มต้น] ข้อมูลสถิติทั้งหมด',
    'template' =>
    [
...
<li>{shares_title}:<em>{shares}</em></li>
    ...
    'styleid' => '107',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] หนึ่งบทนำ + หัวข้อสองคอลัมน์',
    'template' =>
    [
...
<hr class="da" />',
    ...
    'styleid' => '108',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] สไลด์รูปภาพกระทู้',
    'template' =>
    [
      'raw' => '<div class="module cl slidebox">
<ul class="slideshow">
...
runslideshow();
    ...
    'styleid' => '109',
    'blockclass' => 'forum_thread',
    'name' => '[ค่าเริ่มต้น] รายการรูปภาพกระทู้',
    'template' =>
    [
      'raw' => '<div class="module cl ml">
<ul>
...
<div class="tag-cloud-module">
	<div class="tag-cloud-container">
		[loop]
		<a href="{url}"
		   title="{title} ({related_count} รายการ)"
