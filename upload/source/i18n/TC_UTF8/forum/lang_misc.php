...
$lang =
	...
	'attach' => '附件',
	'attach_pay' => '收費附件',
	'attach_credits_policy' => '查看積分策略説明',
	'attach_img' => '圖片附件',
	'attach_readperm' => '閲讀權限',
	...
	'connectguest_message_search' => ['尚未登錄', '先登錄'],
	'connectguest_message_replace' => ['尚未 <a href="member.php?mod=connect" class="xi2">完善賬號資訊</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">綁定已有賬號</a> ', '先 <a href="member.php?mod=connect" class="xi2">完善賬號資訊</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">綁定已有賬號</a> '],
	'connectguest_message_mobile_search' => ['尚未登錄', '先登錄'],
