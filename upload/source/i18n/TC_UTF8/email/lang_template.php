...
$lang =
	...
	'email_register_explain' => '新用戶註冊説明',
...
或錯誤的填寫了生日資訊。本郵件不會多次重複發送，',
	...
	'email_to_friend_reason' => '在 {$_G[\'member\'][\'username\']} 通過 {$_G[\'setting\'][\'bbname\']} 的“推薦給朋友”功能推薦瞭如下的內容給您。',
	...
	'email_to_invite_reason' => ' {$_G[\'member\'][\'username\']} 通過 {$var[\'bbname\']} 的“發送邀請碼給朋友” 功能推薦瞭如下的內容給您。',
	'email_to_invite_not_official' => '請注意這封信僅僅是由用戶使用 “發送邀請碼給朋友”發送的，不是網站官方郵件，',

	'invitemail_subject' => '{username}邀請您加入{sitename}，併成為好友',
	'invitemail_from' => 'Hi，我是{$var[\'username\']}，邀請您也加入{$var[\'sitename\']}併成為我的好友',
	...
	'invite_payment_subject' => '購買邀請碼',
	'invite_payment_msg' => '歡迎您光臨{$var[\'bbname\']}（{$var[\'siteurl\']}），您的訂單 {$var[\'orderid\']} 已經支付完成，訂單已確認有效。',
	'invite_payment_invitecode' => '以下是您獲得的邀請碼',

	'email_seccode_verify_subject' => '賬號身份驗證',
	'email_seccode_code' => '您的驗證碼為：',
	'email_seccode_verify_msg' => '這封信是由{$var[\'bbname\']}（{$var[\'siteurl\']}）發送的郵件驗證碼，該驗證碼 {$var[\'emailinterval\']} 分鐘內有效！',
	];
