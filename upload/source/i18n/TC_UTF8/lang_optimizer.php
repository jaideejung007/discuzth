...
$lang =
	...
	'optimizer_dbbackup_clean_delete' => '檢測到 {filecount} 個數據備份文件(目錄: ./data/backup_xxx)，<br>請儘快手工複製到安全位置備份，然後刪除這些文件',
	...
	'optimizer_patch_have' => '您有 {patchnum} 個，請儘快更新',
	...
	'optimizer_setting_cache_index_desc' => '開啓此功能可減輕服務器負載',
	'optimizer_setting_cache_optimize_desc' => '設置緩存時間為900秒',
	'optimizer_setting_cache_post' => '緩存帖子',
	'optimizer_setting_cache_post_desc' => '開啓此功能可減輕服務器負載',
	'optimizer_setting_cache_post_optimize_desc' => '設置緩存時間為900秒',
	'optimizer_setting_optimizeviews' => '優化更新主題瀏覽量',
	'optimizer_setting_optimizeviews_desc' => '開啓此功能可減輕更新主題瀏覽量時對服務器產生的負載',
	'optimizer_setting_optimizeviews_optimize_desc' => '開啓此功能',
	'optimizer_setting_delayviewcount' => '附件下載量延遲更新',
	'optimizer_setting_delayviewcount_desc' => '延遲更新附件的瀏覽量，可明顯降低訪問量很大的站點的服務器負擔',
	'optimizer_setting_delayviewcount_optimize_desc' => '開啓此功能',
	'optimizer_setting_preventrefresh' => '查看數開啓防刷新',
	'optimizer_setting_preventrefresh_desc' => '開啓防刷新，可明顯降低服務器壓力',
	'optimizer_setting_preventrefresh_optimize_desc' => '開啓此功能',
	...
	'optimizer_setting_lazyload_optimize_desc' => '開啓此功能',
	'optimizer_setting_sessionclose' => '關閉session機制',
	'optimizer_setting_sessionclose_desc' => '關閉session機制以後，可明顯降低站點的服務器負擔，建議在線用戶數超過2萬時開啓本功能<br>注意：遊客數和用戶的在線時長將不再進行統計，論壇首頁和版塊列表頁面的在線用戶列表功能將不可用',
	'optimizer_setting_sessionclose_optimize_desc' => '開啓此功能',
	...
	'optimizer_setting_rewriteguest_desc' => '開啓此項，則 Rewrite功能只對遊客和搜索引擎有效，可減輕服務器負擔',
	'optimizer_setting_rewriteguest_optimize_desc' => '開啓此功能',
	'optimizer_setting_chgusername_othertable' => '同步修改其他表用戶名',
	'optimizer_setting_chgusername_othertable_desc' => '關閉此項，避免改名時修改過多用戶表，可減輕服務器負擔',
	'optimizer_setting_chgusername_othertable_optimize_desc' => '關閉此項',
	'optimizer_inviteregister_tip' => '註冊項中開啓邀請註冊後,設置不受邀請碼限制的地方列表,適合地方社區設置',
	...
	'optimizer_remote_need' => '您開啓了正常站點無需開啓的遠程調用功能,請檢查是否是主動開啓',
	...
	'optimizer_recyclebin_no_need' => '版塊都已經開啓回收站了',
	'optimizer_recyclebin_need' => '版塊沒有開啓回收站<br>{forumdesc}',
	...
	'optimizer_usergroup_need_allowgroupposturl' => '圈子是否允許發站外URL',
	...
	'optimizer_usergroup_need_allowgroupdirectpost' => '圈子允許直接發帖',
	'optimizer_usergroup4_no_need' => '禁止發言用戶組設置正常',
	'optimizer_usergroup5_no_need' => '禁止訪問用戶組設置正常',
	'optimizer_usergroup6_no_need' => '禁止IP用户組設置正常',
	'optimizer_cloudsecurity_no_need' => '防水牆已開啓',
	...
	'optimizer_loginpwcheck_need' => '弱密碼登錄檢測未開啓',
	'optimizer_loginpwcheck_no_need' => '弱密碼登錄檢測已開啓',
	'optimizer_loginoutofdate_need' => '異常登錄檢測未開啓',
	'optimizer_loginoutofdate_no_need' => '異常登錄檢測已開啓',
	'optimizer_postqqonly_need' => '發帖需要綁定QQ號檢測未開啓',
	'optimizer_postqqonly_no_need' => '發帖需要綁定QQ號檢測已開啓',
	'optimizer_aggid_need' => '“管理員，超級版主，版主”QQ登錄檢測未開啓',
	'optimizer_aggid_no_need' => '“管理員，超級版主，版主”QQ登錄檢測已開啓',
	...
	'optimizer_security_daily_need' => '開啓防水牆每日優化，可清除刪帖後首頁痕跡',
	'optimizer_security_daily_no_need' => '該計劃任務已開啓',
	'optimizer_dos8p3_need' => 'DOS 8.3 文件名支持錯誤開啓',
	'optimizer_dos8p3_no_need' => 'DOS 8.3 文件名支持未開啓或底層不支持',
	'optimizer_httphost_need' => '空 HOST 訪問已開啓',
	'optimizer_httphost_no_need' => '空 HOST 訪問支持未開啓或底層不支持',
	];
