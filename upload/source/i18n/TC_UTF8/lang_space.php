...
$lang = [
	...
	'blog_li_ext' => '<dd class="xg1"><a href="home.php?mod=space&uid={uid}&do=blog&id={blogid}" target="_blank">({viewnum})次閲讀</a><span class="pipe">|</span><a href="home.php?mod=space&uid={uid}&do=blog&id={blogid}#comment" target="_blank">({replynum})個評論</a></dd>',
	...
	'block_group_no_content_publish' => '，<a href ="forum.php?mod=group&action=create">創建自己的圈子</a> 或 <a href ="group.php?mod=index">加入圈子</a>',
