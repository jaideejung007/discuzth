...
(
	...
	'login_ip_noaccess' => '<a href="https://go.discuzth.com/dzx35-fix-admin-login-howto" target="_blank">การเปลี่ยน IP ใหม่อาจทำให้เกิดปัญหาเข้าสู่ระบบไม่ได้ ตรวจสอบวิธีแก้ปัญหาได้ที่นี่</a>',
