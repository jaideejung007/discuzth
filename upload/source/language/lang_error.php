...
(
	...
	'suggestion_plugin' => 'หากคุณเป็นผู้ดูแลเว็บ เราขอแนะนำให้คุณลองปิดปลั๊กอิน <a href="admin.php?action=plugins&frames=yes" class="guess" target="_blank">{guess}</a> และลอง <a href="admin.php?action=tools&operation=updatecache&frames=yes" class="guess" target="_blank">อัปเดตแคช</a> หากปัญหาได้รับการแก้ไขหลังจากปิดปลั๊กอินแล้ว ขอแนะนำให้ติดต่อผู้จำหน่ายปลั๊กอินเพื่อขอความช่วยเหลือ',
	'suggestion' => 'หากคุณเป็นผู้ดูแลเว็บ ขอแนะนำให้ลอง<a href="admin.php?action=tools&operation=updatecache&frames=yes" target="_blank">อัปเดตแคช</a> คุณยังสามารถใช้<a href="https://www.discuz.net/" target="_blank">เว็บไซต์ Discuz! อย่างเป็นทางการ</a>เพื่อขอความช่วยเหลือ หากคุณแน่ใจว่านี่เป็นข้อบกพร่องของตัวโปรแกรมเอง คุณสามารถ<a href="https://gitee.com/discuz/DiscuzX/issues" target="_blank">เปิด Issue ใหม่</a> เพื่อแจ้งให้พวกเราได้รับทราบต่อไป',
