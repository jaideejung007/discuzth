...
(
	...
	'error_end_message' => '<a href="http://{host}">{host}</a> ได้บันทึกข้อมูลข้อผิดพลาดนี้อย่างละเอียดแล้ว เราขออภัยในความไม่สะดวกที่เกิดขึ้นในการเข้าชมของคุณ',
	'suggestion_user' => 'หากคุณเป็นผู้ใช้งาน ขอแนะนำให้คุณลองรีเฟรชหน้าเว็บ ปิดหน้าต่างเบราว์เซอร์ทั้งหมดแล้วทำการดำเนินการใหม่อีกครั้ง หากยังไม่สามารถแก้ไขได้ ขอแนะนำให้คุณถ่ายภาพหน้าจอทั้งหมดและบันทึกเก็บไว้ จากนั้นแจ้งปัญหานี้ให้ผู้ดูแลเว็บไซต์ต่อไป',
	'suggestion_plugin' => 'หากคุณเป็นผู้ดูแลเว็บไซต์ ขอแนะนำให้คุณลองปิดปลั๊กอิน <a href="admin.php?action=plugins&frames=yes" class="guess" target="_blank">{guess}</a> และ<a href="admin.php?action=tools&operation=updatecache&frames=yes" class="guess" target="_blank">อัปเดตแคช</a>ในศูนย์การจัดการ (AdminCP) เมื่อปิดปลั๊กอินแล้วปัญหาได้รับการแก้ไข ขอแนะนำให้คุณติดต่อผู้จัดจำหน่ายปลั๊กอินโดยแนบภาพหน้าจอให้ละเอียดครบถ้วนเพื่อขอความช่วยเหลือเพิ่มเติมต่อไป',
	'suggestion' => 'หากคุณเป็นผู้ดูแลเว็บไซต์ ขอแนะนำให้คุณลอง<a href="admin.php?action=tools&operation=updatecache&frames=yes" target="_blank">อัปเดตแคช</a>ในศูนย์การจัดการ (AdminCP) หรือติดต่อเราผ่านทาง<a href="https://www.dismall.com/" target="_blank">เว็บไซต์ Discuz! อย่างเป็นทางการ</a>เพื่อขอความช่วยเหลือ หากคุณแน่ใจว่านี่เป็นข้อบกพร่องของตัวโปรแกรมเอง คุณยังสามารถส่งปัญหาผ่านการสร้าง <a href="https://gitee.com/discuz/DiscuzX/issues" target="_blank">Issue ใหม่</a>ถึงเราได้อีกด้วย',
