...
/*jaideejung007*/		echo '<iframe frameborder="0" width="0" height="0" allowTransparency="true" src="http://log.discuz.in.th/outer.php?siteurl='.urlencode($default_appurl).'&platform=Discuz&version='.DISCUZ_VERSION.'&release='.DISCUZ_RELEASE.'&th_revision='.DISCUZ_TH_REVISION.'"></iframe>';
