...
$lang = array(
	...
	'return' => 'ย้อนกลับ',
	'install_wizard' => 'เครื่องมือติดตั้ง',
	...
	'error_stuck_msg' => 'ความคืบหน้ากระบวนการติดตั้งใช้เวลานานเกินไป และคำขอที่เกี่ยวข้องอาจมีบางอย่างผิดปกติเนื่องจากการหมดเวลาของเครือข่ายหรือข้อผิดพลาดร้ายแรงของเซิร์ฟเวอร์',
	...
	'advice_mysqli_connect' => 'กรุณาตรวจสอบว่าโมดูล mysqli โหลดอย่างถูกต้องแล้ว',
	...
	'advice_json_encode' => 'ฟังก์ชันนี้ต้องใช้ PHP เพื่อรองรับ JSON โปรดติดต่อผู้ให้บริการเพื่อตรวจสอบให้แน่ใจว่าฟีเจอร์นี้เปิดใช้งานอยู่',
	...
	'init_link_note' => 'ติดตามความเคลื่อนไหวข่าวสารดิสคัส! รวมไปถึงการดาวน์โหลดและแลกเปลี่ยนข้อมูลทางเทคนิค',
...
<ol>
   ...
   <li>หากคุณต้องการใช้ซอฟต์แวร์หรือผู้ใช้บริการของเทนเซ็นต์ คลาวด์ เพื่อวัตถุประสงค์ทางการค้า คุณต้องปฏิบัติตามกฎหมายที่เกี่ยวข้องของสาธารณรัฐประชาชนจีน หากคุณต้องการจัดเตรียมวิธีการสนับสนุนทางเทคนิคหรือเนื้อหาการสนับสนุนทางเทคนิค กรุณาให้บริการสนับสนุนด้านเทคนิคอย่างเป็นทางการ (https://www.discuz.net/)</li>
...
<ol>
   ...
   <li>ไม่ว่าในกรณีใด ไม่ว่าจะมีการแก้ไขหรือตกแต่ง หรือระดับของการแก้ไข ตราบใดที่ผลิตภัณฑ์ เทนเซ็นต์ คลาวด์ ทั้งหมดหรือบางส่วนถูกใช้โดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษร ชื่อผลิตภัณฑ์ เทนเซ็นต์ คลาวด์ ที่ส่วนท้ายของหน้าและเว็บไซต์ของบริษัท เทนเซ็นต์ คลาวด์ (http://cloud.tencent.com หรือ https://www.discuz.net) และลิงก์ไปยังศูนย์แอปพลิเคชันอย่างเป็นทางการในระบบหลังบ้านของโปรแกรม (https://addon.dismall.com) ต้องถูกเก็บรักษาไว้ และไม่สามารถลบ แก้ไข หรือแทนที่ได้</li>
