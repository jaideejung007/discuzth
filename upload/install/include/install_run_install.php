...
if(!defined('RUN_MODE') || RUN_MODE != 'install') {
...
if($method == 'show_license') {
	...
	if(VIEW_OFF) {
		...
		/*discuzth*/
		echo '<iframe frameborder="0" width="0" height="0" allowTransparency="true" src="https://logs.discuzth.com/outer.php?id=installed&siteurl='.urlencode($default_appurl).'&platform=Discuz&version='.DISCUZ_VERSION.'&release='.DISCUZ_RELEASE.'&threvision=0"></iframe>';
		show_footer();
	}
